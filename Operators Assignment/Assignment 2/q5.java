...
class Mumbai{
	...
	static void noCorona(){
		...
		System.out.println("Go Corona from Mumbai!!!");		
	}
		
	void lockdown(){
		covidActivCases=7500;
		totalCases=9500;
		System.out.println("Cases in Mumbai during lockdown="+totalCases);							
		System.out.println("Active Cases in Mumbai during lockdown="+covidActivCases);

	}
	void noLockdown(){
		covidActivCases=9000;
		totalCases=12000;
		System.out.println("Cases in Mumbai during Unlock="+totalCases);						
		System.out.println("Active Cases in Mumbai during Unlock=" +covidActivCases);
